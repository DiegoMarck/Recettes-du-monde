...
/* themes/contrib/panache/templates/field/field--comment.html.twig */
class __TwigTemplate_d2b8d133dfe15c2eea41b2929c29b31cc14a99bfe560c853f842e2a14fcf3345 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["label_display"] ?? null) == "visually_hidden")) ? ("visually-hidden") : (""))];
  ...
  ";
        ...
        if ((($context["comments"] ?? null) &&  !($context["label_hidden"] ?? null))) {
            ...
            echo "
    <h3 class=\"comment-wrapper-title\" ";
            // line 46
...
";
    ...
    {
        return "themes/contrib/panache/templates/field/field--comment.html.twig";
    }
...
<section{{ attributes.addClass(classes) }}>
  {% if comments and not label_hidden %}
    {{ title_prefix }}
    <h3 class=\"comment-wrapper-title\" {{ title_attributes.addClass(title_classes) }}>{{ label }}</h3>
    {{ title_suffix }}
  {% endif %}
...
", "themes/contrib/panache/templates/field/field--comment.html.twig", "C:\\xampp\\htdocs\\recettes-du-monde\\themes\\contrib\\panache\\templates\\field\\field--comment.html.twig");
    }
